...
export const ROUTER_ADDRESS = '0x25F2c6AC4BcF0F7752a43f501D726C5C0a18bA25'
...
export const TCVNA = new Token(swapChainId, '0x994EA2E9e031F87c8f9110294c667155b81FB898', 10, 'TCVNA', 'TCVNA');
export const TCVNB = new Token(swapChainId, '0x6F3545D676ca5D8aAD397755f813D9A42eEeB24D', 10, 'TCVNB', 'TCVNB');
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...WETH_ONLY,
  [swapChainId]: [...WETH_ONLY[swapChainId], DAI, BUSD, USDT, ETH, TCVNA, TCVNB],
}
...
export const SUGGESTED_BASES: ChainTokenList = {
  ...WETH_ONLY,
  [swapChainId]: [...WETH_ONLY[swapChainId], DAI, BUSD, USDT, TCVNA, TCVNB],
}
